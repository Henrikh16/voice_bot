...
class Gfg:
    ...
    def takeCommand(self):
          ...
          with sr.Microphone() as source:
              ...
              try:
                  ...
                  # Listening voice commands in eng english
                  print("Recognizing")
    ...
    def quitSelf(self):
        self.Speak("Close all that shit?")
        ...
        if choice == 'yes':
            ...
            self.Speak("Goodbye, bitches, see you next start")
            os.system("poweroff")
        if choice == 'no':

            # Idle
            print("Thank u sir")
            self.Speak("Fuck it, see you next time")
